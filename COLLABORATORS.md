# Collaborators — steel-fabrication
...
- **Eukrit Seang** <eukrit@goco.bz>
  ...
  - GitHub: Owner of `eukrit/steel-fabrication`
...
- **Scope:**
  ...
  - **GitHub:** Write on `eukrit/steel-fabrication` (branch protection on `main` gates all merges)
