...
3. **Continue automatically when no human input is needed** — proceed through the plan/todo list without asking. Only stop for: destructive actions, missing credentials, genuine ambiguity, or explicit user request.
