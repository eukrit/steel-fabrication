...
### 3. GitHub
- [ ] Branch protection on `main`: applied via `apply-branch-protection.sh eukrit/steel-fabrication`
...
- [ ] Remove GitHub collaborator: `gh api -X DELETE repos/eukrit/steel-fabrication/collaborators/[username]`
